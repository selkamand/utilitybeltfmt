...
fmtpercent <- function(number, decimal_places = 1, proportion = FALSE){
  lifecycle::deprecate_warn(when = "0.0.0.9000", what = "utilitybeltfmt::fmtpercent()", with = "fmt::fmtpercent()")
...
fmtscientific <- function(number){
  lifecycle::deprecate_warn(when = "0.0.0.9000", what = "utilitybeltfmt::fmtscientific()", with = "fmt::fmtscientific()")
